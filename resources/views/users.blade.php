                    ...
                    <table class="min-w-full border-collapse border border-gray-200 bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEqQJKTWksgjqnydjTihpmk35XXMHUlMNW-g&s" class="w-10 h-10 rounded-full">
                                </td>
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6">
                                    <img src="https://www.storypick.com/wp-content/uploads/2022/12/16.jpeg" class="w-10 h-10 rounded-full">
                                </td>
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTE1JOtpAZ115A1oWC0wJ6LE8bkzP0Eyn0vsYBeXlwJXIqbBHyhbsx9DAHpWWS9sN_ogYI&usqp=CAU" class="w-10 h-10 rounded-full">
                                </td>
